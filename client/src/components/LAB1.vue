<template>
  <v-card class="mx-auto" max-width="1000" min-height="100">
    ...
    <v-stepper v-model="e1" :alt-labels="altLabels">
      <v-stepper-header>
        <v-stepper-step :complete="e1 > 1" step="1">brief</v-stepper-step>
        <v-divider></v-divider>
        <v-stepper-step :complete="e1 > 2" step="2">intro</v-stepper-step>
        <v-divider></v-divider>
        <v-stepper-step :complete="e1 > 3" step="3">1</v-stepper-step>
        <v-divider></v-divider>
        <v-stepper-step :complete="e1 > 4" step="4">2</v-stepper-step>
        <v-divider></v-divider>
        <v-stepper-step :complete="e1 > 5" step="5">3</v-stepper-step>
        <v-divider></v-divider>
        <v-stepper-step :complete="e1 > 6" step="6">4</v-stepper-step>
        <v-divider></v-divider>
        <v-stepper-step :complete="e1 > 7" step="7">5</v-stepper-step>
        <v-divider></v-divider>
        <v-stepper-step step="8">6</v-stepper-step>
      </v-stepper-header>
      ...
      <v-stepper-items>
        ...
        <v-stepper-content step="3">
            <v-card-subtitle>
              <p class="subtitle-1 text--primary">
                ...
                คลิกเข้าไปที่ Router ที่เราพึ่งวางไปจะเข้าสู่หน้าต่างดังภาพด้านล่าง
        ...
        <v-stepper-content step="5">
          <v-card-subtitle>
            ...
            <p class="subtitle-1 text--primary">
              ...
              นี่คือ config ที่เราพึ่ง set ให้กับ Router ของเราโดยเราจะเห็นคำว่า --More-- ที่ด้านล่างสุด 
              ถ้าเรากด enter จะเป็นการโชว์ข้อมูลบรรทัดต่อมาทีละบรรทัด แต่ถ้าเรากด spacerbar จะเป็นการโชว์ข้อมูลทีละหลายบรรทัด<br/>
            ...
            <p class="subtitle-1 text--primary">
              ทำการปิดและเปิด Router อีกครั้ง จากนั้นใช้คำสั่งเพื่อดูว่า config ที่เราได้เขียนไว้ที่ startup-config นั้นทำงานหรือไม่<br/>
            </p>
            <p class="subtitle-1">
              R1# show running-config<br/>
            </p>
        ...
        <v-stepper-content step="6">
          <v-card-subtitle>
            <p class="subtitle-1 text--primary">
              จากนั้นให้ทำการ Assign IP address ให้กับ R1 โดยให้ Interface GigabitEthernet0/0/0(เขียนแบบย่อว่า g0/0/0) มี IP address คือ 192.168.100.10 255.255.255.0<br/>
            </p>
            <p class="subtitle-1">
